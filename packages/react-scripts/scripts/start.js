...
const DEFAULT_PORT = parseInt(process.env.PORT, 10) || 4000; // @first-iteration
...
checkBrowsers(paths.appPath, isInteractive)
  ...
  .then(port => {
    ...
    // There are no urls that the user can access
    const urls = {
    ...
    const serverConfig = createDevServerConfig(); // @first-iteration
